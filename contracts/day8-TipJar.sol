/*要点
1.货币汇率:因为1ETH=10^18wei → 1美元= 0.0005 ETH，即5 * 10^14
2.
3.
*/
...
contract TipJar {
    ...
    string[] public supportedCurrencies;  // List of supported支持 currencies货币/这个动态数组帮助跟踪添加的所有货币代码，以便以后可以循环访问它们。
    ...
    function addCurrency(string memory _currencyCode, uint256 _rateToEth) public onlyOwner {
        ...
        // Add to the list if it's new如果它是新的，则添加到列表中
        if (!currencyExists) {
